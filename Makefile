...
tests: ## Run tests
	docker-compose -f $(or $(DOCKER_COMPOSE_FILE), docker-compose.yml) exec web sh -x ./run_tests.sh
...
shell: ## Exec shell
	docker-compose -f $(or $(DOCKER_COMPOSE_FILE), docker-compose.yml) exec web python manage.py shell_plus
